...
SWIFT_CLASS_NAMED("IBPCart")
@interface IBPCart : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface IBPCart (SWIFT_EXTENSION(NamogooIBPSDK))
...
- (nonnull instancetype)initWithSKU:(NSString * _Nonnull)SKU orderedAmount:(NSInteger)orderedAmount categories:(NSArray<NSString *> * _Nullable)categories itemCost:(double)itemCost OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("IBPEvent")
@interface IBPEvent : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface IBPEvent (SWIFT_EXTENSION(NamogooIBPSDK))
...
SWIFT_CLASS("_TtC13NamogooIBPSDK22IBPEventParamConverter")
@interface IBPEventParamConverter : NSObject
...
enum IBPInternalEventType : NSInteger;

SWIFT_CLASS("_TtC13NamogooIBPSDK21IBPEventTypeConverter")
@interface IBPEventTypeConverter : NSObject
+ (NSString * _Nonnull)eventNameFrom:(enum IBPInternalEventType)event SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class SwizzleLogObject;

SWIFT_CLASS("_TtC13NamogooIBPSDK19IBPEventsDispatcher")
@interface IBPEventsDispatcher : NSObject
...
@property (nonatomic, readonly, copy) NSString * _Nonnull couponCode;
@property (nonatomic, readonly) double discount;
@property (nonatomic, readonly) double expiration;
@property (nonatomic, readonly, copy) NSString * _Nonnull incentiveType;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, IBPInternalEventType, open) {
  IBPInternalEventTypeComponentInit = 0,
  IBPInternalEventTypeComponentForeground = 1,
  IBPInternalEventTypeComponentBackground = 2,
  IBPInternalEventTypeComponentRemovedFromVisualHeirarchy = 3,
  IBPInternalEventTypeComponentAddedToVisualHeirarchy = 4,
  IBPInternalEventTypeAppActive = 5,
  IBPInternalEventTypeAppBackground = 6,
  IBPInternalEventTypeAppForeground = 7,
  IBPInternalEventTypeAppInit = 8,
  IBPInternalEventTypeAppInactive = 9,
  IBPInternalEventTypeAppMemoryWarning = 10,
  IBPInternalEventTypeAppDestroyed = 11,
  IBPInternalEventTypeAppOpenedFromUrl = 12,
  IBPInternalEventTypeActionSent = 13,
  IBPInternalEventTypeButtonTapped = 14,
  IBPInternalEventTypePickerSelected = 15,
  IBPInternalEventTypeTextFieldEntered = 16,
  IBPInternalEventTypeGestureLocation = 17,
  IBPInternalEventTypeGestureCaptured = 18,
  IBPInternalEventTypeUrlGenerated = 19,
  IBPInternalEventTypeKeyboardShow = 20,
  IBPInternalEventTypeKeyboardHide = 21,
  IBPInternalEventTypeLabelTextSet = 22,
  IBPInternalEventTypeVendorEvent = 23,
};
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull couponsUsed;
@property (nonatomic, readonly) double taxCost;
@property (nonatomic, readonly) double shippingCost;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull payload;
- (nonnull instancetype)initWithOrderId:(NSString * _Nonnull)orderId couponsUsed:(NSArray<NSString *> * _Nonnull)couponsUsed taxCost:(double)taxCost shippingCost:(double)shippingCost payload:(NSDictionary<NSString *, id> * _Nonnull)payload OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS_NAMED("IBPPreviousValidCart")
@interface IBPPreviousValidCart : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface IBPPreviousValidCart (SWIFT_EXTENSION(NamogooIBPSDK))
...
SWIFT_CLASS_NAMED("IBPSessionTime")
@interface IBPSessionTime : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface IBPSessionTime (SWIFT_EXTENSION(NamogooIBPSDK))
...
SWIFT_CLASS_NAMED("IBPViewControllerTime")
@interface IBPViewControllerTime : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface IBPViewControllerTime (SWIFT_EXTENSION(NamogooIBPSDK))
...
- (void)startWithId:(NSString * _Nonnull)vendorId customerId:(NSString * _Nullable)customerId sessionId:(NSString * _Nullable)sessionId cartDelegate:(id <IBPCartDelegate> _Nullable)cartDelegate referrer:(NSString * _Nullable)referrer options:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)options;
...
- (void)displayIncentiveOverlayInViewController:(UIViewController * _Nullable)vc;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
